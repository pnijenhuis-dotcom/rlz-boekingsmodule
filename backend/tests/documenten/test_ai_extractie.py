...
class TestAiVoorstel:
    ...
    def test_opnieuw_extraheren_na_transiente_fout(
        ...
        def _timeout(pdf_bytes: bytes, *, client=None, verbruik_referentie=None, mail_context=None) -> AiFactuurExtractie:
        ...
        def _werkt(pdf_bytes: bytes, *, client=None, verbruik_referentie=None, mail_context=None) -> AiFactuurExtractie:
            aanroepen.append(pdf_bytes)
            return _fake_extractie()
    ...
    def test_metriek_in_tijdlijn(
        ...
        def _met_metriek(pdf_bytes: bytes, *, client=None, verbruik_referentie=None, mail_context=None) -> AiFactuurExtractie:
...
class TestWaarborgProjectadministratie:
    ...
    def test_opnieuw_extraheren_vanaf_handmatig_afmaken(
        ...
        monkeypatch.setattr(
            "app.extractie.service.extraheer_inkoopfactuur",
            lambda pdf_bytes, *, client=None, verbruik_referentie=None, mail_context=None: _fake_extractie(volledig=True),
        )
        status = service.herextraheer_document(
            administratie_id=administratie_id,
            document_id=resultaat.document_id,
    ...
    def test_ai_fout_is_zichtbaar_en_laat_upload_slagen(
        ...
        def _kapot(pdf_bytes: bytes, *, client=None, verbruik_referentie=None, mail_context=None) -> AiFactuurExtractie:
