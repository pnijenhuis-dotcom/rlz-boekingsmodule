...
CREATE TABLE boekhouding.projectverdeling (
    ...
    hercontrole_bevinding text,
    CONSTRAINT ck_projectverdeling_hercontrole_bevinding CHECK (((hercontrole_bevinding IS NULL) OR (hercontrole_bevinding = 'omzet_ontbreekt'::text))),
...
CREATE TABLE boekhouding.reconciliatie_instelling (
    ...
    gewijzigd_door uuid,
    gewijzigd_op timestamp with time zone DEFAULT now() NOT NULL,
    soort_standen jsonb DEFAULT '{}'::jsonb NOT NULL,
...
CREATE TABLE boekhouding.weekstaat_dag (
    ...
    doorfactureren boolean DEFAULT true NOT NULL,
...
CREATE TABLE platform.administratie (
    ...
    btw_plichtig boolean DEFAULT true NOT NULL,
    btw_plichtig_bron text,
    btw_plichtig_gewijzigd_op timestamp with time zone,
    btw_plichtig_rlz_signaal boolean,
    btw_plichtig_rlz_gezien_op timestamp with time zone,
    ...
    CONSTRAINT ck_administratie_btw_plichtig_bron CHECK (((btw_plichtig_bron IS NULL) OR (btw_plichtig_bron = ANY (ARRAY['rlz'::text, 'mens'::text])))),
...
CREATE TABLE platform.odoo_koppeling (
    ...
    rekening_btw_afwikkeling_historisch_id integer,
