...
# FV-01 (25-09): a_ubl_zonder_beeld = de RLZ-export-UBL zónder PDF — het bijlage-paneel toont de UBL-kaart, niet de XML.
CASUSSEN=(a_universal_nederland a_ubl_zonder_beeld b_floor c_spot_services h_bdo m_incasso_factuur)
