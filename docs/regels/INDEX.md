...
| Werkloop, nametingen, deploy en productie-toegang | `docs/regels/werkloop-productie.md` | `backend/app/db/**`, `backend/app/lezen/**`, `backend/app/cli.py`, `backend/app/main.py`, `backend/app/config.py`, `backend/app/logboek.py`, `backend/migrations/**`, `scripts/**`, `.github/**`, `opdrachten/**`, `docs/rapporten/**` |
