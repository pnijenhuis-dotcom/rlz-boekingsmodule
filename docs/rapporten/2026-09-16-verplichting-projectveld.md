...
## Sweeps
Niet afgerond in die run: de overflow-sweep stond op 49 van ~87 metingen toen de run eindigde; de keten-sweep is niet gestart. Gecommit door de vervolgrun van 16-09 avond (omzet-store-routering) ná een verse `tsc -b` (groen). De sweeps draaien mee in de afronding van die vervolgrun.
